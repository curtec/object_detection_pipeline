...
5. At the command prompt type python -m venv {the name that you require for your venv}<br><br>![venv](https://github.com/user-attachments/assets/17de97ff-1851-4916-b09a-38efd91de0cb)<br><br><br>
7. 
